...
import { useGetSongsByCountryQuery } from '../redux/services/shazaamCore';
    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="flex flex-wrap sm:justify-start justify-center gap-8">
                {data?.map((song, i) => <SongCard key={song.key} song={song} isPlaying={isPlaying} data={data} i={i} activeSong={activeSong} />)}
            </div>
        </div>
    )
};
